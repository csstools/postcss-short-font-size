...
describe('postcss-short-font-size', function () {
	it('transforms normal property', function (done) {
		test('basic', {}, done);
	});

	it('ignores normal property when prefix is assigned', function (done) {
	...
	it('transforms prefixed property when prefix is assigned', function (done) {
